  ...
  return (
    <main className="bg-[#fdfbf7] text-[#0b2b15] px-4 py-12 sm:px-6 md:px-10 max-w-6xl mx-auto">
      ...
      <section className="mb-14">
        <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl tracking-wide uppercase font-bold mb-4 text-center">
          Nos prestations
        </h1>
            ...
            {service.packs.map((pack, i) => (
              ...
              >
                ...
                <div className="p-5 flex-1 flex flex-col">
                  <h3 className="font-semibold text-xl mb-1">{pack.title}</h3>
