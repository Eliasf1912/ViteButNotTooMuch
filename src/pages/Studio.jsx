...
export default function Studio() {
  return (
    <main className="bg-[#fdfcf8] text-[#0b2b15] font-[Satoshi] px-6 py-16">
      <Helmet>
  <title>Le studio | ViteButNotTooMuch — Design graphique & direction artistique</title>
  ...
  <meta name="theme-color" content="#0b2b15" />
      ...
      <header className="max-w-3xl mx-auto text-center mb-16">
        ...
        <p className="text-base md:text-lg leading-relaxed text-[#0b2b15]/80">
          Fondé par des passionnés de design, <strong>ViteButNotTooMuch</strong> allie esthétique
          minimaliste et efficacité. Nous croyons à la beauté dans la simplicité.
        </p>
      </header>
      ...
      <section className="max-w-4xl mx-auto mb-16 space-y-6">
        ...
        <p className="text-base leading-relaxed">
          Vite, mais pas n’importe comment. On privilégie la clarté, l’impact visuel et la cohérence.
          Chaque projet démarre avec une vision claire : marier rapidité et rigueur créative.
        </p>
      </section>
      ...
      <section className="max-w-4xl mx-auto mb-16 space-y-6">
        ...
        <p className="text-base leading-relaxed">
          Le studio a été fondé par Clara Martin, designer indépendante passionnée par les systèmes visuels,
          le branding et l’éditorial. Après plusieurs années de projets en freelance, elle a lancé
          <strong> ViteButNotTooMuch </strong> pour proposer un design à la fois expressif, pointu et humain.
        </p>
      </section>
      ...
      <section className="max-w-4xl mx-auto mb-16 space-y-6">
        ...
        <ul className="list-disc pl-5 space-y-2 text-base">
          <li>Identités visuelles & chartes graphiques</li>
          <li>Direction artistique & branding</li>
          <li>UI/UX design & maquettes web</li>
          <li>Design éditorial et supports imprimés</li>
        </ul>
      </section>
